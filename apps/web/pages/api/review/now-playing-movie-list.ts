...
import { NowPlayingMovieListReview, NowPlayingMovieListReviewsDTO } from "@/entities/reviews";
...
export default async function handler(
  ...
  try {
    ...
    const nowPlayingMovieReviews = (await Promise.allSettled(promises)).reduce<NowPlayingMovieListReview[]>(
      (prev, settledResult) => {
